...
export function Nav() {
  ...
  return (
    <nav className="nav" aria-label="主要導覽"><div className="wrap in">
...
export function Page({ children }: { children: ReactNode }) {
  return (<><a className="skip-link" href="#main-content">跳到主要內容</a><Nav /><main id="main-content" tabIndex={-1}>{children}</main><Footer /></>)
}
